...
#else
  gdk_window_invalidate_region (icon_view->priv->bin_window, (GdkRegion *)invalid_region, TRUE);
#endif
 ...
 *
 * Return value: a newly-allocated drawable (gtk2) or cairo surface (gtk3) of the drag icon.
 *
 * Since: 0.3.1
 **/
#if GTK_CHECK_VERSION (3, 0, 0)
